...
SilicaGridView {
    ...
    property int horizontalMargin: {
        ...
        if (margin) {
            ...
            return Math.max((!isPortrait && Screen.topCutout.height > 0)
                            ...
                            largeScreen ? 6 * Theme.paddingLarge
    ...
    property real minimumCellWidth: largeScreen ? 1.6 * Theme.itemSizeExtraLarge
    ...
    property real minimumCellHeight: largeScreen ? 1.6 * Theme.itemSizeExtraLarge
