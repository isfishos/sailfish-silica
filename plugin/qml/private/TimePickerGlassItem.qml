...
GlassItem {
    ...
    falloffRadius: palette.colorScheme === Theme.DarkOnLight ? 0.20 : 0.22
    radius: palette.colorScheme === Theme.DarkOnLight ? 0.22 : 0.25

    color: !highlighted ? Theme.lightPrimaryColor
